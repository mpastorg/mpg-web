<template>
	<div class="Doc">
		...
		.tg .tg-onff{color:#2C3E50;text-align:left;vertical-align:middle}
		...
		<div class="tg-wrap"><table class="tg">
			...
			<tr>
				...
				<th class="tg-ru17">Description</th>
				<th class="tg-ru17">URL</th>
			</tr>
			</thead>
			<tbody>
			<tr>
				...
				<td class="tg-7h26"><a href="http://www.madastur.com/doc-auth/swagger-ui/">doc-auth/swagger-ui/</a></td>
			</tr>
			<tr>
				<td class="tg-0lax">2020-12-27</td>
				<td class="tg-onff">Doc for micro-service Activity:</td>
				<td class="tg-7h26"><a href="http://www.madastur.com/doc-activity/swagger-ui/">doc-activity/swagger-ui/</a></td>
			</tr>
			</tbody>
			</table>
		</div>
